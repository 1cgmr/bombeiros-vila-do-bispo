...
- A Associação tem subnavegação para Apresentação, Estatutos e Órgãos Sociais. A primeira pode mostrar a Mensagem do Presidente. Estatutos apresenta artigos de exemplo editáveis e identificados como provisórios enquanto faltar o PDF oficial associado; quando o PDF estiver disponível, mostra o documento oficial. Órgãos Sociais mostra registos confirmados e cartões de exemplo marcados como provisórios, sem pessoas. Os dados publicados continuam a vir do Sanity.
